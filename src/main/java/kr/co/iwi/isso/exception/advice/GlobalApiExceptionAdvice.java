...
public class GlobalApiExceptionAdvice {
	...
	public ResponseEntity<Response> HttpMessageNotReadableException(HttpServletRequest request,
		...
		e.printStackTrace();
		return new ResponseEntity<>(new Response("700", "파라미터 누락"), null, HttpStatus.OK);
	}
	...
	public ResponseEntity<Response> MethodArgumentNotValidException(HttpServletRequest request,
		...
		e.printStackTrace();
		return new ResponseEntity<>(new Response("701", "필수값 누락"), null, HttpStatus.OK);
	}
	...
	public ResponseEntity<Response> UnauthorizedException(HttpServletRequest request, HttpServletResponse response,
		...
		e.printStackTrace();
		// return new ResponseEntity<>(new Response("800", "인증 실패"), null, HttpStatus.UNAUTHORIZED);
		return new ResponseEntity<>(new Response("800", "인증 실패"), null, HttpStatus.OK);
	}
	...
	public ResponseEntity<Response> TokenExpiredException(HttpServletRequest request, HttpServletResponse response,
		...
		e.printStackTrace();
		// return new ResponseEntity<>(new Response("801", "인증 만료"), null, HttpStatus.UNAUTHORIZED);
		return new ResponseEntity<>(new Response("801", "인증 만료"), null, HttpStatus.OK);
	}
